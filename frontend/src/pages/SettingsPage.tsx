        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`w-full text-left px-3.5 py-3 rounded-lg transition-all duration-150 flex items-center gap-3 relative focus:outline-none ${
                isActive
            ...
            >
              {isActive && (
                <span className="absolute left-0 top-3 bottom-3 w-1 rounded-r bg-indigo-600" />
              )}
      ...
      <div className="md:col-span-3">
        {activeTab === "profile" && (
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-5 bg-slate-50/50 rounded-xl p-5 border border-slate-100">
                ...
                <div className="text-center sm:text-left">
                  ...
                  <div className="flex items-center justify-center sm:justify-start gap-2 mt-1">
                    <span className="text-[10px] font-semibold bg-indigo-50 text-indigo-700 px-2 py-0.5 rounded-full border border-indigo-100/50">
                      Super Admin
                    </span>
                    <span className="text-[10px] text-slate-400 font-mono">ID: 10042</span>
                  </div>
                  <p className="text-[11px] text-slate-400 mt-2">Member since Jan 2025 • Active Session</p>
                </div>
              </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full text-sm border border-slate-200 rounded-lg pl-9 pr-3 py-2.5 bg-slate-50/30 text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-50/35 transition-all"
                    />
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end">
              <button
                onClick={() => notify("User profile updated successfully")}
                className="text-xs font-semibold px-4 py-2.5 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 shadow-sm hover:shadow-indigo-600/10 transition-all"
              >
        ...
        {activeTab === "bot" && (
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            <div className="p-6 md:p-8 border-b border-slate-100">
              ...
              <p className="text-xs text-slate-400 mt-1">Configure security credentials and tokens for the bot integration.</p>
            </div>
            ...
            <div className="p-6 md:p-8 space-y-6">
              <div className="space-y-1.5">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-1">
                    <input
                      readOnly
                      value={showToken ? "7284:AAH-x92kLp_gS3dF7qRtYzW1nMvBcXeUio" : "••••••••••••••••••••••••••••••••••••"}
                      className="w-full text-sm border border-slate-200 rounded-lg px-3 py-2.5 pr-10 bg-slate-50/30 text-slate-600 focus:outline-none font-mono"
                    />
                    <button
                  ...
                  <button
                    onClick={() => notify("Bot token updated successfully")}
                    className="px-4 py-2.5 text-xs font-semibold rounded-lg border border-indigo-200 text-indigo-600 hover:bg-indigo-50 transition-colors"
                  >
                    Update Token
                  </button>
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    defaultValue="GoldSystemBot"
                    className="w-full text-sm border border-slate-200 rounded-lg pl-8 pr-3 py-2.5 bg-slate-50/30 text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-50/35 transition-all font-medium"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-3">
              <button
                onClick={() => notify("Test bot connection successful")}
                className="flex items-center justify-center gap-2 text-xs font-semibold px-4 py-2.5 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 transition-colors w-full sm:w-auto"
              >
                <Send size={14} /> Test Bot Connection
              </button>
              <button
                onClick={() => notify("Telegram bot settings saved")}
                className="text-xs font-semibold px-4 py-2.5 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 shadow-sm hover:shadow-indigo-600/10 transition-all w-full sm:w-auto text-center"
              >
                Save Bot Config
              </button>
            </div>
        ...
        {activeTab === "security" && (
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div className="space-y-1.5">
                  ...
                  <input
                    defaultValue="30"
                    type="number"
                    className="w-full text-sm border border-slate-200 rounded-lg px-3 py-2.5 bg-slate-50/30 text-slate-800 placeholder-slate-400 focus:outline-none focus:bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-50/35 transition-all"
                  />
                </div>
                <div className="space-y-1.5">
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex flex-col sm:flex-row justify-between items-center gap-3">
              <button
                onClick={() => notify("Password policy updated")}
                className="flex items-center justify-center gap-2 text-xs font-semibold px-4 py-2.5 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-50 transition-colors w-full sm:w-auto"
              >
                <Lock size={14} /> Update Policy Settings
              </button>
              <button
                onClick={() => notify("Security settings updated successfully")}
                className="text-xs font-semibold px-4 py-2.5 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 shadow-sm hover:shadow-indigo-600/10 transition-all w-full sm:w-auto text-center"
              >
        ...
        {activeTab === "system" && (
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end">
              <button
                onClick={() => notify("System operating hours updated")}
                className="text-xs font-semibold px-4 py-2.5 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 shadow-sm hover:shadow-indigo-600/10 transition-all"
              >
                Save Business Hours
              </button>
